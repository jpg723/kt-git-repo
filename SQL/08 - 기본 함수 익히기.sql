...
SELECT emp_id, emp_name, dept_id, gender, hire_date, REVERSE(REPLACE(SUBSTR(phone, 3, 100), '-', '')) AS phone
    FROM employee
    WHERE retire_date IS NULL;
...
-- [ORACLE] TO_CHAR(SYSDATE, 'HH24:MM:SS')
...
-- [MSSQL] DATEPART(WEEKDAY, GETDATE()), DATENAME(WEEKDAY, GETDATE())
-- [ORACLE] TO_CHAR(SYSDATE, 'd'), TO_CHAR(SYSDATE, 'day')
